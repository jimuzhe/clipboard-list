...
class ClipboardListApp {
    ...
    private setupEventListeners(): void {
        ...
        this.trayManager.on('toggle-always-on-top', (enabled: boolean) => {
            // 切换窗口置顶状态
    ...
    private setupIPCListeners(): void {
        ...
        this.ipcService.on('window-hide', () => this.windowManager.hide()); this.ipcService.on('window-toggle-always-on-top', () => {
   ...
   */
    ...
    private initializeTrayMenuState(): void {
        try {
            ...
            this.trayManager.updateAlwaysOnTopStatus(alwaysOnTop); logger.debug('Tray menu state initialized', {
